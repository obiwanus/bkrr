...
init 2:
    ...
    python:
        ...
        make_sprites_for('dv', 'swim_rose', ['es:body', 'mod:swim', 'mod:rose', 'es:<emotion>'], emotions=('angry', 'guilty', 'rage', 'sad', 'shy'), distances=['normal'])
        make_sprites_for('dv', 'swim_rose', ['es:body', 'es:swim', 'mod:rose', 'es:<emotion>'], emotions=['surprise'], distances=['normal'])
