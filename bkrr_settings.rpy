...
init python:
    ...
    bkrr_item_list = ("knife", "paint", "tape", "key", "food", "powder", "accumulator", "comb", "pills", "apple", "note", "shark_tooth", "matchbox", "love_letter")
...
init 2:
    ...
    image bg ext_music_club_verandah_final_rehearsal = im.MatrixColor(MOD_IMAGES + "bg/ext_music_club_verandah_final_rehearsal.jpg", bkrr_tint["sunset"])
