...
init python:
    ...
    bkrr_gallery_grid = {
        "bg":(
            ...
            (["semen_room_clean_bkrr", False], ["ext_beach_water_day", BKRR_IMAGES + "bg/ext_beach_water_day.jpg"], ["int_infirmary_night_guitar", False], ["int_infirmary_sunset_guitar", False], ["int_infirmary_day_guitar", False], ["ext_pier_day", False]),
            (["ext_pier_sunset", False], ["int_clubs_male_day_wrecked", False], ["int_clubs_male_sunset_wrecked", False], ["ext_stage_big_day_str_bkrr", False], ["ext_stage_big_day_const_bkrr", False], ["ext_stage_big_day_evening_empty", False]),
            (["ext_backstage_big_day_night", False], ["ext_backstage_big_day_night_noplank", False], ["int_bus_people_day_bkrr", False], ["ext_street_night", False], ["int_entrance_bkrr", bkrr_fast_composite(BKRR_IMAGES + "bg/int_entrance_outside.jpg", BKRR_IMAGES + "bg/int_entrance.png")], ["int_entrance_bkrr_with_cat", bkrr_fast_composite(BKRR_IMAGES + "bg/int_entrance_outside.jpg", BKRR_IMAGES + "bg/int_entrance.png", BKRR_IMAGES + "bg/int_entrance_cat.png")]),
            (["int_school_night", bkrr_fast_composite(BKRR_IMAGES + "bg/int_school_ext.jpg", BKRR_IMAGES + "bg/int_school_night.png")], ["int_classroom_night", bkrr_fast_composite(BKRR_IMAGES + "bg/int_classroom_ext.jpg", BKRR_IMAGES + "bg/int_classroom_night.png")])
        ),
        "cg":(
    ...
    bkrr_ach_list = (
        # ("start", u"Запустить 1-ое демо."),  # удолили, потому что все задолбали спрашивать
