...
label bkrr_day12_common:
    ...
    "В гребне оказалось четыре отверстия для пальцев. Я взял его, как показала Славя, и осторожно провел им по волосам Мику. Получалось, словно расчесываешь и гребнем и пальцами одновременно. Мику глубоко вздохнула и села, чтобы мне было удобнее."
    ...
    "Мику вздрогнула, но ничего не сказала, только подалась назад, почти прижавшись ко мне спиной. Я обнял её за плечи и повторил поцелуй. Срывающимся шепотом Мику поинтересовалась:"
    mi "Ой… что ты делаешь. {w}А вдруг кто-то увидит?"
    me "Так ведь нет никого."
    mi "Всё равно..."
    "Теплые ладошки Мику легли поверх моих рук и мягко прижали их, то ли поощряя, то ли пытаясь остановить. Осмелев окончательно, я принялся посасывать мочку её уха и попытался опустить руки ниже, к груди."
