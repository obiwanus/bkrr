...
label bkrr_day6_common:
    ...
    th "Точно, Ульяне."
    "Только по-настоящему любимому парню можно подложить червяка в тарелку. Да и шуточки про «насиловать будешь?» и тоже наводят на мысли. То-то она так выспрашивала, кто мне нравится."
