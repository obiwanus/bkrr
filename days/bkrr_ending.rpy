...
label bkrr_epilogue_common:
    ...
    "Но секунду спустя Мику… Мария… Кем бы она ни была, уже прижималась ко мне и, всхлипывая, шептала, как боялась ошибиться, как не могла понять – я ли это, и как ей было страшно, вдруг я её не узнаю…"
    ...
    mi "Ты…{w} ведь больше никуда не денешься?"
    me "Никуда!"
