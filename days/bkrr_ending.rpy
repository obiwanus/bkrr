...
label bkrr_epilogue_common:
    ...
    "Я расстелил на полу одеяло, переложил на него одежду, а сам устроился в кровати вожатой, стараясь не обращать внимание на запахи духов и шампуня, идущие от постели."
    ...
    "Я машинально потянулся за полотенцем и провёл по лицу. На нём остались светло-розовые пятна."
    ...
    mt "Такой хлопотной смены у меня не было с…{w} Да вообще не было. Ни разу!"
    ...
    "Я стянул полотенце и зевнул так, что чуть не вывихнул челюсть."
    ...
    "Я смутился и отошёл к двери. Там вовсю светило солнце, а по дорожкам сновали пионеры.{w} Они были отвратительно бодры и полны энергии. Стало завидно."
    ...
    mt "И когда я говорю «навести порядок», я имею в виду именно «навести порядок».{w} Это не значит замести грязь под коврик и с честным лицом сдать мне ключи. Вопросы есть?"
    ...
    "Неровная шеренга пионеров быстро разошлась по домикам."
    ...
    mt "А вас, товарищ нездешний, я попрошу остаться. Серьёзные вещи обсуждать будем."
    me "А музклуб?"
    ...
    mt "Если на стоянке к тебе не бросятся незнакомые люди, крича: «Сынуля, ты приехал!!!», и родители Мику не пригласят тебя пожить у них, то поедешь на этот адрес. {w}Поживёшь в моей квартире, а потом, когда я приеду, мы что-нибудь придумаем."
    ...
    "Я снова перечитал фамилию, втайне надеясь, что она изменилась…{w} Шутка вполне в духе моего двойника. Если бы я захотел подшутить на прощание, то сочинил бы что-то в этом духе."
    ...
    th "Кстати, я так и не узнал, какая же у неё фамилия. Если папина, то ещё ладно, но если мамина… Наверняка что-нибудь заковыристое и японское."
    ...
    mt "Нет, вы посмотрите на этого жмота. Четыре недели я его кормлю, пою и воспитываю, купила полный чемодан одежды, а он испортил две рубашки и пытается украсть третью."
    me "Ладно, ладно…"
    ...
    "На секунду мне показалось, что она куда старше, чем хочет казаться. Но очень быстро иллюзия исчезла."
    ...
    us "Товарищи музыканты, если кто-то надеется, что пол сам себя помоет, то зря! Может, будем начинать? Я не хочу в спортивке домой ехать, мне ещё переодеться надо."
    ...
    us "Не умничай! Я не хочу, чтобы следующая смена спрашивала, что за хрюшки тут репетировали!"
    ...
    me "Смотри с хорошей стороны. Так мы до вечера бы собирались."
    ...
    dv "НЕТ! Скоро ехать. Сейчас напьёшься чаю, потом автобус будем каждые десять минут останавливать.{w} Приедем, тогда вечером соберёмся и сходим куда-нибудь."
    ...
    "Наконец, последняя нотная тетрадь легла на полку, последняя пылинка смахнута тряпкой, шторы задёрнуты, чтобы яркий солнечный свет не портил лак на инструментах, чашки вымыты, струны на гитарах отпущены, барабаны и рояль зачехлены.{w} Сделана ещё куча необязательных мелочей."
    ...
    mi "Ты не сувенир, ты — мой любимый. А надо что-нибудь такое, чтобы на полочку поставить и вспоминать об этом лете… {w}Вот только что? Даже фотографий не получилось, Ульяна плёнку засветила."
    me "Ничего! Сейчас что-нибудь придумаем."

    hide mi with dissolve

    "Я огляделся… Но до появления сувенирных киосков, где можно купить чашку с фотографией лагеря, ручку или значок, оставалось ещё добрых двадцать лет. Даже завалящего карманного календарика с фотографией причала не было."
    ...
    "Она улыбнулась, сорвала ещё один цветок и устроила его в волосах."
    ...
    "Мутный он какой-то. Сначала загадочным образом превратился из «ЛиАЗа» в «Икарус», потом изменил моё тело и выплюнул в мистическом лагере, потом через пару дней явился снова, подразнил, оттолкнул непонятной силой и растворился в вечерних сумерках."
    ...
    me "Мне страшно. А вдруг я сяду и… {w}исчезну. Иначе — никак?"
    ...
    mt "Хватит разговоров. Мне вас нужно ещё по головам пересчитать… И вообще."
    ...
    mt "Всем спасибо, все свободны. А теперь — организованно, подчёркиваю: {u}ор-га-ни-зо-ван-но{/u} садимся в автобус, ваши ряды — в задней части автобуса, по обе стороны."
    mt "Тяжёлые сумки ставим под ноги или отдаём в багажное отделение, наверх — только лёгкие. Обивку сидений не пачкаем, неприличных слов на ней не пишем, в салоне не мусорим."
    mt "Если кто-то чувствует, что надо посетить уединённое белокаменное строение, сделайте это сейчас."
    mt "Отряд, разойдись!"

    hide mt with dissolve

    "Кто-то принялся перекладывать сумки вниз, девчонки окружили Ольгу, чтобы попрощаться, кто-то отошёл к друзьям из других отрядов…"
    "Мику помогала Алисе устроить гитару на багажной полке и привязывать инструмент милыми синими ленточками."
    ...
    mt "Что значит «это я привёз»? Я вижу инвентарный номер!"
    ...
    "Кот важно мяукнул, то ли соглашаясь, то ли требуя чего-нибудь вкусного."
    ...
    "К счастью, наш отряд был небольшим, и мы с Мику устроились там, где нам не будут мешать нескромные взгляды попутчиков. {w}Алиса и Ульяна заняли места напротив."
    ...
    scene cg bkrr_epilogue_1 with dissolve

    mi "У меня что-то на лице?"
    me "Нет. Просто…"
    "Я вздохнул и накрыл её руку своей. Как ей объяснить, что последние несколько дней я всё время боялся, что исчезну и больше никогда её не увижу?"
    ...
    "Я коснулся твёрдой обложки свидетельства о рождении. {w}Глупо, конечно, но потёртая зелёная книжка внушала куда больше уверенности, чем все обещания, данные мне вожатой, двойником и девочкой-кошкой. {w}Какая уверенность может быть в чуде, пусть уже и случавшемся? {w}А документ есть документ. {w}Если бы ещё не фамилия…"
    ...
    scene cg bkrr_epilogue_1 at bkrr_bus_shaking with dissolve
    ...
    "Мику показала язык, положила голову мне на плечо и закрыла глаза."
    ...
    "Вдруг наша вожатая — ещё один фантом, созданный этим загадочным лагерем? Вдруг этого адреса нет, а соседка сделает удивлённое лицо и скажет, что не знает никакую Ольгу Дмитриевну."
    "Нужно будет как-то устраиваться. Как? Кем? Куда?"
    "Конечно, Ольга обещала, что всё будет нормально. Но обещания — это одно, а перспектива ночевать на вокзале или объяснять родителям Мику, что идти мне некуда и что из дома я не сбегал — совсем другое. {w}Куда более реальное."
    ...
    th "Или спросить, слышала ли она о путешествиях во времени."
    "Мелочь в кармане, кое-какие вещи из моей прошлой жизни, вроде зажигалки с фонариком, телефон в конце концов…"
    ...
    "Не хочу даже думать, как она отреагирует. Любовь, конечно, слепа, но не настолько же."
    ...
    "Как привидение."
    "Я отчётливо видел обивку кресла, просвечивающую сквозь лицо Мику."
    ...
    dv "Сень, ты как? Не укачало? Ты зелёный весь… И глаза дикие."
    ...
    dv "Нет, блин! С симфоническим оркестром! Сначала с Толей, потом с тобой. Ещё вопросы?"
    ...
    "Моя любимая девушка только что медленно растаяла в воздухе."
    ...
    th "Может, я всё ещё в медпункте, и всё это — бред от лекарств и температуры?"
    ...
    "Наконец, я смог совладать хотя бы с веками. Открывая глаза, я был готов увидеть что угодно. {w}Свою квартиру, потолок домика в лагере, даже серый бетон бомбоубежища под лагерем."
    ...
    "И второй — во сне. Это была она. {w}Она говорила с той парочкой в квартире, так похожей на мою…"
    me "Можно её вернуть?"

    stop sound_loop fadeout 15
    play music music_list["into_the_unknown"] fadein 10

    "Моя собеседница молча посмотрела в окно."
    ...
    ml "Но есть одна молоденькая глупышка, которая смогла сделать лагерь и всё вокруг него… более материальным.{w} Для себя и… ещё для одного человека."
    ...
    "Она помолчала."
    ml "Вот только мне не нравится, как они обошлись с вами двумя. {w}Это жестоко… и бессмысленно."
    ...
    dr "Если совсем развезло, зачерпни снежка, лицо потри, сразу попустит. Всегда так делаю, лучше всякого кофе! Только жёлтый не бери!"
    ...
    th "Это что, был сон?"
    th "Или…"
    "Я машинально уставился на свои руки. Маленьких твёрдых мозолей на пальцах больше не было.{w} Полученный в «Совёнке» загар сменился привычной бледностью, а едва заметный ожог от чайника исчез."
    ...
    "Даже если она переживёт мою повзрослевшую внешность, то из этой берлоги выскочит в ужасе. И больше никогда не вернётся."
    ...
    "Когда очередной пакет с какими-то бутылками и старым хламом загрохотал вниз по трубе, под ноги мне с писком метнулось что-то небольшое и чёрное."
    ...
    "И что этим я себе что-то там компенсирую, а моя фантазия ищет выхода в такой форме, и лучше бы мне…"
    ...
    "Родители были очень рады произошедшим со мной переменам. Ещё бы: сын, на котором можно было ставить крест, взялся за ум, пошёл на работу, привёл в порядок квартиру.{w} Ещё бы невесту хорошую нашёл…"
    "Но с последним пунктом не задалось. Я так и не смог снова влюбиться."
    "Наверное, потому, что я подсознательно сравнивал всех с {i}ней{/i}."
    ...
    "Племянница пожала плечами и фыркнула."
    ...
    th "Как же она называлась? То ли «Сонет», то ли «Аккорд»… Что-то музыкальное."
    ...
    "Но это была {b}она{/b}. Не могла не быть."
    ...
    me "Очень! А я уж было решил… Что она из какого-то детского фильма. {w}Почему-то сразу подумал о пионерах."
    ...
    "По коридору раздались лёгкие шаги. Племяшка устала меня ждать и отправилась на поиски."
    th "Не хватало ещё, чтобы она решила, будто Стася моя дочь."
    ...
    sta "Дядь Семён, я тут Ромку встретила с родителями. Они меня подвезут, ты доберёшься домой один?"
    ...
    mi "Надо же, сколько времени. Хорошо, что вы пришли, иначе я бы сидела тут до ночи, с меня станется.{w} Музыка так увлекает, я перестаю следить за временем. С вами когда-нибудь так бывало?"
    ...
    "Я слушал её голос, поскрипывание снега под ногами, и боялся поверить, что это наяву.{w} А ещё — лихорадочно пытался понять, что же делать дальше."
    ...
    mi "Ой, я вас не заболтала? Мне часто говорят, что я слишком разговорчивая. И на родине, до переезда сюда, и здесь…{w} Я, наверное, уже надоела, да?"
    ...
    "Но секунду спустя Мику…{w} Мария…{w} Кем бы она ни была, уже прижималась ко мне и, всхлипывая, шептала, как боялась ошибиться, как не могла понять, я ли это, и как ей было страшно, вдруг я её не узнаю…"

    $ bkrr_set_volume("sound", 0.2)
    stop sound_loop2 fadeout 3
    play sound bkrr_sfx_list["bus_leaving"] fadein 3

    "Водитель пустующего автобуса явно решил, что не стоит ждать эту ненормальную пару, и уехал без нас."

    stop sound fadeout 3
    stop ambience fadeout 10
    stop sound_loop fadeout 3

    "Я покрепче прижал Мику к себе и глупо улыбался, стараясь не сойти с ума от переполнявших меня чувств."
    ...
    "Снег пошёл сильнее, как будто хотел скрыть нас от нескромных глаз и дать возможность побыть вдвоём."
