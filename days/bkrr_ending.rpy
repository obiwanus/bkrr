...
label bkrr_epilogue_common:
    ...
    "Наутро всеми овладело чемоданное настроение. Праздник пролетел быстро, как будто и не было ничего.{w} Только флажки с гирляндами напоминали о том, что ещё вчера здесь были иностранные гости, играла музыка и четверо пионеров захватывали сцену… Чтобы вскоре её покинуть."
    ...
    un "Едут по домам, в город. И понятия не имеют, что вы с Мику были в одном автобусе с ними."
    ...
    un "Наверное. Этот лагерь вытворяет странные штуки с памятью. Там я была уверена, что мы давно знаем друг друга… А теперь я помню, что она появилась немного раньше тебя."
    ...
    un "Ты не единственный, кого они использовали… И по чьим головам прошлись."
    me "О чём ты?"
    ...
    un "Или наивный дурачок в теле пионера."
    me "Откуда ты всё это знаешь? Кто ты?"
    un "Если я расскажу, это всё испортит… Ты ведь хочешь вернуть Мику? Мой ответ ничем не поможет."
    me "А… Что поможет?"
    un "Для начала можешь минутку помолчать. Мне нужно…"
    "Она вздохнула."
    ...
    un "Вспомнить, как это было."
    un "Мику сюда уже не вернётся. Тем более, что этого «сюда» на самом деле нет."
    me "Как нет? Где мы тогда?"
    un "Нигде. И в то же время – везде. Если хочешь, можешь назвать это «суперпозиция»."
    un "Но скоро мы окажемся… Где-то. Пока не уверена, где."
    me "Восхитительно…"
    un "Хватит жаловаться. Всё могло быть хуже."
    me "Куда уж хуже-то?"
    "Она подвинулась ближе."
    un "Хуже может быть всегда. И это как раз наш случай."
    me "Что вообще происходит?"
    un "Эти двое решили не рисковать."
    un "Тебя здесь быть не должно. Любое твоё действие, даже взятое со стола яблоко может вызвать непредсказуемые изменения… Как круги на воде."
    un "Поэтому источник возмущений быстро убрали подальше. А источник – ты."
    me "Откуда ты всё это знаешь?"
    un "Они и рассказали. Юля действительно не могла жить там, у вас. Потому что её, строго говоря, нет.{w} Она существует только в лагере и не может выйти за его пределы."
    un "Но есть одна молоденькая глупышка, которая смогла сделать лагерь и всё вокруг него… более материальным.{w} Для себя и… еще для одного человека."
    me "Ничего себе… И что будет дальше?"
    un "Став реальной здесь, эта кошка сможет выбраться в другой мир и остаться в нём. Так себе план, но другого у нас… У них не было."
    me "Мику… Сделала лагерь реальным?"
    "Моя собеседница негромко хмыкнула."
    un "Нет. Она потрясающий музыкант и хорошо поёт, но такие вещи ей не под силу."
    me "Тогда зачем всё это?"
    un "Чтобы эта глупая девчонка захотела сделать то, что сделала.{w} Она уже создала тихий мирок где её желания исполнились, и повторять это ещё раз просто не стала бы."
    me "А для меня, значит, стала бы?"
    un "Для вас двоих она пошла бы на всё. Чувство вины – страшная сила. Не спрашивай, почему."
    me "Не буду. {w}И как? У них получилось?"
    un "Наверное. Не знаю.{w} Я уже давно не видела снов про лагерь до сегодняшнего дня, так что… Наверное, я им больше не нужна."
    "Она помолчала."
    un "Вот только мне не нравится, как они обошлись с вами двумя. {w}Это жестоко… и не нужно."
    un "Но кое чего они не учли."
    ...
    "А потом улыбнулась той самой улыбкой, от которой я был без ума. Без узнавания, но приветливо."
    ...
    mi "Вы пришли слишком рано, она пока никак не называется. Я сама её сочинила  и ещё только думаю над названием. Знаете ведь название – это половина смысла для мелодии.{w} У меня очень много идей, но в названии точно будет слово «ожидание». А может, подберу что-нибудь на японском…"
    ...
    sta "Дядь Семён, я тут Андрея встретила  с родителями. Они меня подвезут, ты доберешься домой один?"
    ...
    mi "Надо же, сколько времени. Очень удачно, что вы появились, иначе я бы засиделась здесь до ночи.{w} Музыка так увлекает, я перестаю следить за временем. С вами когда-нибудь так бывало?"
    ...
    "По дороге мы беседовали о всякой ерунде.{w} Расстояние до остановки стремительно сокращалось, а я всё не мог заставить себя сделать следующий шаг."
    ...
    show mii surp outside close at center with dissolve
    ...
    me "Нет-нет, совсем наоборот.{w} Скажите, Мария, вы с таким воодушевлением говорите про джаз, он действительно вам нравится?"
    ...
    mi  "Да, очень. А что?"
    me "Завтра в «Кирпиче» будет вечер старой музыки. Рокабилли и Рэя Чарльза обещать не могу, но я слышал, что играет неплохой джаз-банд.{w} И ещё ходят слухи, что там варят замечательный кофе. Хотите, сходим и вместе проверим?"
    ...
    mi "«Кирпич»? Давно хотела там побывать. Я согласна. Но только при одном условии!{w} Нет, при двух условиях!"
    me "Каких же?"

    show mii laugh outside close at center with dspr

    mi "Во-первых, что мы перейдем на «Ты».{w} И во-вторых, что ты не сделаешь квадратные глаза, когда узнаешь, как меня зовут по-настоящему. В школе меня все называют Мария, чтобы дети не думали про имя учителя вместо музыки. Договорились?"
    ...
    "Хотелось бежать по улице, хватать всех подряд за одежду и кричать, кричать им в уши, что я счастлив."
