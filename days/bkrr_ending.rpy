...
label bkrr_epilogue_common:
    ...
    "Казалось бы, чего проще.{w} Но после всех этих поисков я боялся ошибиться и принять желаемое за действительное…{w} Боялся ошибиться.{w} Снова."
    ...
    play sound bkrr_sfx_list["bus_arriving"] fadein 3
    ...
    "Но секунду спустя Мику… Мария… Кем бы она ни была, уже прижималась ко мне и сбивчиво рассказывала, как боялась ошибиться, как не могла понять – я ли это, что ей было так страшно, вдруг я её не узнаю…"
    ...
    mi "Ты… ведь больше никуда не денешься?"
    me "Никуда!"
